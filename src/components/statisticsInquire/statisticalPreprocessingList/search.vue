                ...
                <el-col :span="5" style="width:290px;">
                    <el-form-item>
                        <el-select v-model="searchData.pjfs" placeholder="请选择评价方式" size="small" style="width:250px;" clearable>
                            <el-option v-for="item in levelTypeOptions" :key="item.value" :label="item.label" :value="item.value"></el-option>
                        </el-select>
                    </el-form-item>
                </el-col>
                <el-col :span="1">
...
<script>
import { getEvaluKind,getLevelType} from '@/components/OnlineEvaluation/onlineEvaluation.js'
export default {
    name:'search',
    inject: ["search"],
    props:{// 其他组件传入的值
