<template>
  <div id="zTable" class="dataTable">
    ...
    <div class="page-table" :style="'height: '+tableHeight+';'">
      ...
      >
        ...
        <el-table-column
          align="center"
          label="操作"
          :width="opertionColumnWidth"
          v-if="tableBaseConfig.showOperation == undefined?true:tableBaseConfig.showOperation"
        >
          <template slot-scope="scope">
            <el-button
              v-for="item in toolBarConfig.eachRow.default"
              :key="item.id"
              :id="item.id"
              type="primary"
              :style="item.style"
            ...
            <el-dropdown trigger="click" v-show="toolBarConfig.eachRow.dropdown.length > 0">
              ...
              <el-dropdown-menu slot="dropdown">
                <el-dropdown-item class="clearfix">
                  <el-button
                    v-for="item in toolBarConfig.eachRow.dropdown"
                    :key="item.id"
                    :id="item.id"
                    :style="item.style"
                    type="primary"
    ...
    <div
      class="page-box"
      v-if="tableBaseConfig.showPageBar == undefined?true:tableBaseConfig.showPageBar"
    >
      <el-pagination
