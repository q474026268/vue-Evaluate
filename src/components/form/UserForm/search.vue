<template>
    <div id="search">
        <el-form ref="searchForm" :inline="true" :model="searchData" class="demo-form-inline">
            ...
            <el-form-item>
                <el-button type="primary" size="small" @click="searching" icon="el-icon-search">查询</el-button>
                <el-button type="primary" size="small" @click="clear" icon="el-icon-refresh">清空</el-button>
            </el-form-item>
        </el-form>
    </div>
</template>
