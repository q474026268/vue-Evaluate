<template>
  <div id="evaluationManage">
    <div id="nbgkmydDiv">
      ...
      <router-link class="nbgkmydDivSon" tag="div" :to="{name:'indexManageList'}">指标管理</router-link>
      <router-link class="nbgkmydDivSon" tag="div" :to="{name:'evaluateModelList'}">模板表管理</router-link>
      <router-link class="nbgkmydDivSon" tag="div" :to="{name:'handoutHistorySearchList'}">分发历史查询</router-link>
    </div>
